...
class MiddlewareService
{
    ...
    public function insertCareplan($new, $eid)
    {
        ...
        // Initialize cURL session
        $ch = curl_init($this->url . "consoleData"); // Corrected line
    ...
    public function insertIssues($sesh, $post, $issueRecord)
    {
        // $encounter_resource = $this->create_encounter_resource($new['encounter'], $new['date'], $new['pid']);
        session_start();
        // Define the data array
        ...
        // echo "<html> <script> console.log(`" . json_encode($data) ."`); </script> </html>";
