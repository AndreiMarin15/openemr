...
// Set the API URL
$apiUrl = 'https://cap-middleware.onrender.com/user/getMaps';
curl_setopt($ch, CURLOPT_HTTPGET, $apiUrl);

// Set options (e.g., headers, authentication)
// ...
...
if (curl_errno($ch)) {
    ...
    // Process the API response (e.g., parse JSON)
